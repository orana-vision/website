  ...
  en: {
    ...
    gr: {
        ...
        experience: {
            ...
            answer_5:
                "Η ομάδα μας έχει μεγάλη εμπειρία στον χώρο και θα σας βοηθήσει να φτάσετε την επιχείρηση σας ένα βήμα παραπέρα! Η όρεξη για ποιοτικό αποτέλεσμα συνδυασμένη με το σύγχρονο σχεδιασμό που σας προσφέρει η Orana, θα αποτέλουσουν την ιδανική διαδικτυακή βιτρίνα σας!",
            answer_6:
            ...
            timeline_3_label: "Σε δύο εβδομάδες",
        ...
        team_member: {
            ...
            bio_3: "Lorem potasium",
        },
    },
    about: {
      about_title: "Who we are",
      mobile_card_front: "We build mobile applications that will take off your business",
      mobile_card_back: "Do you want your business to be easily accessible from mobile? We turn your website or e-shop into a mobile app that your customers can install on their mobiles!",
      eshop_card_front: "We build your own e-shop so that your business operates 24 hours a day",
      eshop_card_back: "Do you want your business to be easily accessible from mobile? We turn your website or e-shop into a mobile app that your customers can install on their mobiles!",
    ...
    experience: {
      ...
      question_5: "Γιατί να επιλέξω την Orana;",
      question_6: "Θέλω κάτι πιο εξειδικευμένο για την επιχείρηση μου. Μπορείτε να με βοηθήσετε;",
      answer_1: "Το website είναι κάτι πολύ καλό.",
      answer_2: "Έχουμε τις χαμηλότερες τιμές τις αγοράς!",
      answer_3: "Το πολύ σε δύο εβδομάδες το website θα βρίσκεται online!",
      answer_4: "Αναλαμβάνουμε να αναβαθμίσουμε το παλιό σας website μετατρέποντας το σε σύγχρονο!",
      answer_5: "Η ομάδα μας έχει μεγάλη εμπειρία στον χώρο και θα σας βοηθήσει να φτάσετε την επιχείρηση σας ένα βήμα παραπέρα!",
      ...
      timeline_4_label: "Τελικά",
      timeline_1_desc: "Επικοινωνείτε μαζί μας.",
      timeline_2_desc: "Συζητούμε αναλυτικά για το τι ζητάτε.",
      timeline_3_desc: "Σας παρουσιάζουμε το προιόν που φτιάξαμε ειδικά για εσάς.",
      timeline_4_desc: "Βλέπουμε μαζί τι αλλαγές χρειάζεται για να το φέρουμε ακριβώς στα μέτρα σας.",
    },
    contact: {
    ...
    team_member: {
      ...
      bio_1: "Lorem potasium",
      bio_2: "Lorem potasium",
      bio_3: "Lorem potasium",
    },
  },
  gr: {
    ...
    team_member: {
      ...
      name_2: "Ioannis Gkountras",
      name_3: "Xaris Kemalidis",
      bio_1: "Lorem potasium1",
      bio_2: "Lorem potasium2",
      bio_3: "Lorem potasium3",
    },
  },
};
