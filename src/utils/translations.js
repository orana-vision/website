const translations = {
  ...
  gr: {
    ...
    about: {
      ...
      mobile_card_front: "Κατασκευάζουμε mobile εφαρμογές που θα απογειώσουν την επιχείρηση σας",
      mobile_card_back:
      ...
      eshop_card_front: "Κατασκευάζουμε το δικό σας e-shop ώστε η επιχείρηση σας να λειτουργεί 24 ώρες το 24ωρο",
      eshop_card_back:
    ...
    experience: {
      ...
      question_6: "Θέλω κάτι πιο εξειδικευμένο για την επιχείρηση μου. Μπορείτε να με βοηθήσετε;",
      answer_1: "Ένα website φέρνει πιο κοντά τον πελάτη στην επιχείριση σας αναδεικνύοντας την εξαιρετική σας δουλειά.",
      ...
      answer_3: "Είστε πρωταγωνιστής σε αυτό! Εμείς σας παρουσιάζουμε την δική μας πρόταση σε 3 εβδομάδες και αφού ακούσουμε την γνώμη σας προχωράμε παρακάτω!",
      answer_4: "Αναλαμβάνουμε να αναβαθμίσουμε το παλιό σας website μετατρέποντας το σε σύγχρονο!",
      answer_5:
      ...
      timeline_4_desc: "Βλέπουμε μαζί τι αλλαγές χρειάζεται για να το φέρουμε ακριβώς στα μέτρα σας.",
    },
    contact: {
      other: "'Αλλο",
      write_message: "Γράψτε το μήνυμά σας...",
      wish: "Θα χαρούμε να σας ακούσουμε!",
      orana_quote: "“Μαζί οποιαδήποτε ιδέα για την επιχείρηση σας, θα γίνει πραγματικότητα.”",
