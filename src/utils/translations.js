const translations = {
    en: {
        ...
        about: {
            ...
            mobile_card_back:
                "Do you want your business to be easily accessible from mobile? We turn your website or e-shop into a mobile app that your customers can install on their mobiles!",
        ...
        experience: {
            ...
            answer_5:
                "Η ομάδα μας έχει μεγάλη εμπειρία στον χώρο και θα σας βοηθήσει να φτάσετε την επιχείρηση σας ένα βήμα παραπέρα!",
            answer_6:
