const translations = {
  ...
  gr: {
    ...
    about: {
      ...
      mobile_card_front: "Κατασκευάζουμε mobile εφαρμογές που θα απογειώσουν την επιχείρησή σας",
      mobile_card_back:
        "Θέλετε η επιχείρησή σας να είναι εύκολα προσβάσιμη από το κινητό; Μετατρέπουμε την ιστοσελίδα ή το e-shop σας σε mobile app που μπορούν να εγκαταστήσουν στα κινητά τους οι πελάτες σας!",
      eshop_card_front: "Κατασκευάζουμε το δικό σας e-shop ώστε η επιχείρησή σας να λειτουργεί 24 ώρες το 24ωρο",
      eshop_card_back:
        "Με αυτόν τον τρόπο οι πελάτες σας μπορούν να πραγματοποιούν τις αγορές τους από την άνεση του σπιτιού τους κάθε στιγμή της ημέρας. Αυτόματα η επιχείρησή σας επεκτείνει τα σύνορα της καθώς είναι προσβάσιμη από ολόκληρο τον κόσμο!",
      website_card_front: " Δημιουργούμε την ιστοσελίδα που θα σας κάνει να ξεχωρίσετε από τους υπόλοιπους",
      website_card_back:
        "Η ιστοσελίδα δίνει κύρος στην επιχείρησή σας και εμπνέει εμπιστοσύνη στους πελάτες. Είναι αυτό που θα σας κάνει να ξεχωρίσετε από τους υπόλοιπους και να γίνετε η πρώτη επιλογή.",
    ...
    experience: {
      ...
      question_6: "Θέλω κάτι πιο εξειδικευμένο για την επιχείρησή μου. Μπορείτε να με βοηθήσετε;",
      answer_1: "Ένα website φέρνει πιο κοντά τον πελάτη στην επιχείρησή σας αναδεικνύοντας την εξαιρετική σας δουλειά.",
      answer_2: "Προσφέρουμε οικονομικές λύσεις για τις ανάγκες σας. Μην διστάσετε να επικοινωνήσετε μαζί μας για να συζητήσουμε αναλυτικά!",
      answer_3: "Εμείς σας παρουσιάζουμε την δική μας πρόταση σε 3 εβδομάδες και αφού ακούσουμε την γνώμη σας προχωράμε παρακάτω!",
      answer_4: "Αναλαμβάνουμε να αναβαθμίσουμε το παλιό σας website μετατρέποντάς το σε σύγχρονο!",
      answer_5:
        "Η ομάδα μας έχει μεγάλη εμπειρία στον χώρο και θα σας βοηθήσει να φτάσετε την επιχείρησή σας ένα βήμα παραπέρα! Η όρεξη για ποιοτικό αποτέλεσμα σε συνδυασμό με τον σύγχρονο σχεδιασμό που σας προσφέρει η Orana, θα αποτελέσουν την ιδανική διαδικτυακή βιτρίνα σας!",
      ...
      timeline_3_desc: "Σας παρουσιάζουμε το προιόν που φτιάξαμε ειδικά για εσάς.",
      timeline_4_desc: "Βλέπουμε μαζί τις αλλαγές που χρειάζονται για να το φέρουμε ακριβώς στα μέτρα σας.",
    },
    contact: {
      other: "'Αλλο",
      write_message: "Γράψτε το μήνυμά σας...",
      wish: "Θα χαρούμε να σας ακούσουμε!",
      orana_quote: "“Μαζί θα υλοποιήσουμε οποιαδήποτε ιδέα για την επιχείρησή σας.”",
    ...
    team_member: {
      ...
      bio_1:
        "Παράλληλα με τις σπουδές μου στο τμήμα Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του Αριστοτελείου Πανεπιστημίου Θεσσαλονίκης, ξεκίνησα την επαγγελματική μου καριέρα ως προγραμματιστής και μηχανικός ανάπτυξης λογισμικού στην εταιρία Acta LTD. Όσο οι γνώσεις μου πλήθαιναν, το ενδιαφέρον μου για τον προγραμματισμό μαζί με την όρεξη μου για δημιουργία οδήγησαν σε αυτό που σήμερα βρίσκεται κάτω από το όνομα Orana. Έτσι, μαζί με τους άλλους δύο συνιδρυτές της Orana, αποφασίσαμε να ακολουθήσουμε αυτό το μονοπάτι και να κάνουμε ό,τι καλύτερο μπορούμε για εσάς και για εμάς.",
      bio_2:
        "Φοιτητής στο τμήμα Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του Αριστοτελείου Πανεπιστημίου Θεσσαλονίκης. Αρχικά για εμένα ο προγραμματισμός ήταν ενα ευχάριστο hobby. Με τον καιρό αυτή η ενασχόλησή μου με τον προγραμματισμό απέκτησε μεγαλύτερες διαστάσεις. Πλέον ως συνιδρυτής της Orana, ασχολούμαι σε καθημερινή βάση με projects της εταιρείας, ξεπερνώντας πολλά προβλήματα που προκύπτουν, αλλά και προσθέτοντας μια μοναδική πινελιά, χαρακτηριστική της Orana, που κάνει το κάθε αποτέλεσμα να είναι ξεχωριστό.",
      bio_3: "Φοιτητής στο τμήμα Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του Αριστοτελείου Πανεπιστημίου Θεσσαλονίκης.",
    },
    thank_you: {
