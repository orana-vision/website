    ...
    <>
      <div className="scene">
        ...
        >
          ...
          <div className={selectedOpacity === 2 ? "carousel__cell cell_selected" : "carousel__cell"}>Websites</div>
          <div className={selectedOpacity === 3 ? "carousel__cell cell_selected" : "carousel__cell"}>Mobile Apps</div>
        </div>
      </div>
    </>
  );
