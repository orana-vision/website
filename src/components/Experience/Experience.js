            ...
            <div ref={faqTxtRef} className="flex-experience container">
                ...
                <div ref={timelineRef} className="timeline-container">
                    <Timeline
                        ...
                        <Timeline.Item
                            label={translate(language).experience.timeline_1_label}
                            color="green"
                            className="timeline-item">
                            {translate(language).experience.timeline_1_desc}
                        </Timeline.Item>
                        <Timeline.Item
                            label={translate(language).experience.timeline_2_label}
                            className="timeline-item">
                            {translate(language).experience.timeline_2_desc}
                        </Timeline.Item>
                        <Timeline.Item
                            label={translate(language).experience.timeline_3_label}
                            className="timeline-item">
